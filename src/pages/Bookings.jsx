          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="font-medium">{selectedBooking.turf?.owner?.name || 'N/A'}</p>
              </div>
              <div>
              ...
              {selectedBooking.payment && (
                <>
                  <div>
                    ...
                    <p className="font-medium capitalize">{selectedBooking.payment.payment_method || 'N/A'}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600">Payment Status</p>
                    <p className="font-medium capitalize">{selectedBooking.payment.status || 'N/A'}</p>
                  </div>
                </>
              )}
              <div>
